...
<form onSubmit={updateAccountDetails}> 
  ...
  <div className="passWordDetails">
    ...
    <button type="button" className="requestPasswordReset" onClick={requestPasswordReset} style={{ outline: 'none'}}
  ...
  <div className="submitDiv">
    <button className="updateBtn" disabled={isEdit} type="submit" role="button" aria-label="Save your changes" > 
      Save </button>
