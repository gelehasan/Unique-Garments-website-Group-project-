    ...
    <div className="Itemcontainer">
      ...
      <div className="itemclassName">
        ...
        <div className="sizeGroup">
          <button
            className={` ${selectedSize === "S" ? "selectedSizebtn" : "sizebtn"} `}
            onClick={() => setSelectedSize("S")}
          >
            S
          </button>
          <button
            className={` ${selectedSize === "M" ? "selectedSizebtn" : "sizebtn"} `}
            onClick={() => setSelectedSize("M")}
          >
            M
          </button>
          <button
            className={` ${selectedSize === "L" ? "selectedSizebtn" : "sizebtn"} `}
            onClick={() => setSelectedSize("L")}
          >
            L
          </button>
          <button
            className={` ${selectedSize === "XL" ? "selectedSizebtn" : "sizebtn"} `}
        ...
        <div className="itembtns">
          ...
          <button
            ...
            role="button"
            aria-label="Add items to your cart bag"
          >
